        ...
        >
          ...
          <template #append>
            <div @click="passwordTypeChange" class="eye">
              <svg
                v-if="passwordType === PasswordType.Password"
                class="password-icon"
